    ...
    public static function getInternationalPackages(): array
    {
        return [
            [
                ...
                'name' => 'Thailand',
                'country' => 'Thailand',
                'description' => 'Discover the land of smiles with beautiful beaches, ancient temples, vibrant nightlife, and delicious cuisine. Experience the perfect blend of culture and relaxation.',
            ...
            [
                ...
                'name' => 'Bali (Indonesia)',
                'country' => 'Indonesia',
                'description' => 'Experience the tropical paradise of Bali with stunning beaches, ancient temples, lush rice terraces, and world-class resorts. Perfect for relaxation and adventure.',
            ...
            [
                ...
                'name' => 'Vietnam',
                'country' => 'Vietnam',
                'description' => 'Explore the rich history, stunning landscapes, and vibrant culture of Vietnam. From bustling cities to serene countryside, experience authentic Southeast Asia.',
            ...
            [
                ...
                'name' => 'Baku',
                'country' => 'Azerbaijan',
                'description' => 'Discover the fascinating blend of ancient and modern in Baku. Explore historic old town, modern architecture, and the beautiful Caspian Sea coastline.',
            ...
            [
                ...
                'name' => 'Malaysia',
                'country' => 'Malaysia',
                'description' => 'Experience the diverse beauty of Malaysia with pristine beaches, lush rainforests, modern cities, and rich cultural heritage. A perfect destination for all travelers.',
            ...
            [
                ...
                'name' => 'Africa',
                'country' => 'Multiple Countries',
                'description' => 'Experience the wild beauty of Africa with incredible wildlife safaris, stunning landscapes, rich cultures, and unforgettable adventures across the continent.',
            ...
            [
                ...
                'description' => 'Set sail on an amazing cruise adventure. Explore multiple destinations, enjoy world-class amenities, fine dining, and entertainment while traveling in luxury.',
    ...
    public static function getDomesticPackages(): array
    {
        return [
            ...
            [
                ...
                'name' => 'Leh Ladakh',
                'state' => 'Ladakh',
                'description' => 'Explore the breathtaking landscapes of Leh Ladakh with high-altitude lakes, ancient monasteries, and stunning mountain vistas. A paradise for adventure seekers.',
            ...
            [
                ...
                'description' => 'Experience the beauty of the Himalayas in Himachal Pradesh. Enjoy snow-capped mountains, adventure sports, and serene landscapes in this hill station paradise.',
                'image' => 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=800&h=600&fit=crop',
            ],
            [
                'id' => 4,
                ...
                'description' => 'Discover the enchanting beauty of Sikkim and Darjeeling with tea gardens, mountain views, Buddhist monasteries, and pristine natural landscapes.',
            ...
            [
                ...
                'name' => 'Uttrakhand',
                'state' => 'Uttarakhand',
                'description' => 'Explore the spiritual and natural beauty of Uttarakhand with sacred temples, hill stations, adventure activities, and stunning Himalayan views.',
                'image' => 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop',
            ],
            [
                'id' => 6,
                'name' => '4 Dham Yatra',
                'state' => 'Uttarakhand',
                'description' => 'Embark on a sacred pilgrimage to the four holy shrines of Yamunotri, Gangotri, Kedarnath, and Badrinath. A spiritual journey through the Himalayas.',
                'image' => 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop',
            ],
            [
                'id' => 7,
            ...
            [
                ...
                'name' => 'Karnataka',
                'state' => 'Karnataka',
                'description' => 'Explore the diverse beauty of Karnataka with ancient temples, hill stations, wildlife sanctuaries, and beautiful beaches. Rich in history and culture.',
            ...
            [
                ...
                'description' => 'Discover the tropical paradise of Andaman and Nicobar Islands with pristine beaches, crystal-clear waters, water sports, and rich marine life.',
